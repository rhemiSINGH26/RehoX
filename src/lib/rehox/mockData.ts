...
export const COMPANIES = ["Google", "Microsoft", "Oracle Financial Services Software"] as const;
export type Company = typeof COMPANIES[number];

// Required level (1-10) per company across all 12 categories
export const COMPANY_REQUIRED: Record<Company, Record<CategoryCode, number>> = {
  Google: {
    COD: 9, DSA: 10, OOD: 8, APTI: 8, COMM: 7, AI: 7,
    CLOUD: 7, SQL: 6, SWE: 8, SYSD: 9, NETW: 6, OS: 8, OTHER: 0,
  },
  Microsoft: {
    COD: 8, DSA: 8, OOD: 8, APTI: 7, COMM: 8, AI: 6,
    CLOUD: 9, SQL: 7, SWE: 8, SYSD: 8, NETW: 6, OS: 7, OTHER: 0,
  },
  "Oracle Financial Services Software": {
    COD: 7, DSA: 6, OOD: 7, APTI: 7, COMM: 8, AI: 4,
    CLOUD: 6, SQL: 9, SWE: 7, SYSD: 6, NETW: 6, OS: 6, OTHER: 0,
  },
};
...
export const SAMPLE_JDS: ParsedSource[] = [
  {
    source_type: "jd", source_file: "google_swe.pdf", company: "Google", role: "Software Engineer",
    skills: [
  ...
  {
    source_type: "jd", source_file: "google_ds.pdf", company: "Google", role: "Data Scientist",
    skills: [
  ...
  {
    source_type: "jd", source_file: "microsoft_swe.pdf", company: "Microsoft", role: "Software Engineer",
    skills: [
  ...
  {
    source_type: "jd", source_file: "microsoft_da.pdf", company: "Microsoft", role: "Data Analyst",
    skills: [
  ...
  {
    source_type: "jd", source_file: "ofss_ase.pdf", company: "Oracle Financial Services Software", role: "Associate Software Engineer",
    skills: [
  ...
  {
    source_type: "jd", source_file: "ofss_asa.pdf", company: "Oracle Financial Services Software", role: "Application Support Analyst",
    skills: [
...
export const SAMPLE_RESUMES: SampleResume[] = [
  {
    ...
    source_type: "resume", source_file: "aarav_menon_resume.pdf",
    company: "", role: "New grad — backend",
    ...
    experience: [
      "SDE Intern, mid-size fintech — 6 months on payments infra",
    ],
    skills: [
  ...
  },
  {
    ...
    source_type: "resume", source_file: "priya_shah_resume.pdf",
    ...
    experience: [
      "Analyst, D2C retail startup — 1.5 years, SQL-heavy reporting",
    ],
    skills: [
  ...
  },
  {
    ...
    source_type: "resume", source_file: "rohit_kulkarni_resume.pdf",
    company: "", role: "Application Support",
    ...
    experience: [
      "Support intern, small SaaS — 4 months on L1/L2 tickets",
    ],
    skills: [
  ...
  },
  {
    ...
    source_type: "resume", source_file: "ananya_rao_resume.pdf",
    ...
    experience: [
      "SDE Intern, big tech — 6 months on cloud platform team",
    ],
    skills: [
